...
describe Humanize::Byte do
  ...
  context "#to_human" do
    it '0 should be instance of Bytes' do
      b = Humanize::Byte.new(0)
      expect(b.to_human).to be_a(Humanize::Bytes)
    end

    it '1023 should be instance of Bytes' do
      b = Humanize::Byte.new(1023)
      expect(b.to_human).to be_a(Humanize::Bytes)
    end
    
    it '1024 should be instance of Kilo' do
      b = Humanize::Byte.new(1024)
      expect(b.to_human).to be_a(Humanize::Kilo)
    end
    
    it '1 MB should be instance of Meta' do
      b = Humanize::Byte.new(1024 * 1024)
      expect(b.to_human).to be_a(Humanize::Mega)
    end
    
    it '1 GB should be instance of Giga' do
      b = Humanize::Byte.new(1024 * 1024 * 1024)
      expect(b.to_human).to be_a(Humanize::Giga)
    end
    
    it '1 TB should be instance of Tera' do
      b = Humanize::Byte.new(1024 * 1024 * 1024 * 1024)
      expect(b.to_human).to be_a(Humanize::Tera)
    end

    it '1 PB should be instance of Peta' do
      b = Humanize::Byte.new(1024 * 1024 * 1024 * 1024 * 1024)
      expect(b.to_human).to be_a(Humanize::Peta)
    end
    
    it '1 EB should be instance of Exa' do
      b = Humanize::Byte.new(1024 * 1024 * 1024 * 1024 * 1024 * 1024)
      expect(b.to_human).to be_a(Humanize::Exa)
    end
    
    it '1 ZB should be instance of Zetta' do
      b = Humanize::Byte.new(1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024)
      expect(b.to_human).to be_a(Humanize::Zetta)
    end
    
    it '1 YB should be instance of Yotta' do
      b = Humanize::Byte.new(1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024)
      expect(b.to_human).to be_a(Humanize::Yotta)
    end
  end
end
